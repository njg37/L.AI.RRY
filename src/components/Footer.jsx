...
const Footer = () => {
  ...
  return (
    <footer className= " snap-start bg-slate-900 text-white min-h-[55vh] flex flex-col justify-between pt-16 pb-8 px-6 font-sans">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <p className="text-slate-400 leading-relaxed">
            AI-driven mock tests for competitive exams. Empowering your journey
        ...
        {/* Exams */}
        <div>
          <h3 className="text-lg font-semibold mb-6 border-l-4 border-yellow-400 pl-3">
            Exams
          </h3>
        ...
        {/* Links */}
        <div>
          <h3 className="text-lg font-semibold mb-6 border-l-4 border-blue-500 pl-3">
            Links
          </h3>
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto w-full pt-8 mt-12 border-t border-slate-800 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500 gap-4">
